 ...
 int main(){
          ...
          *pPointer = 10; //assign a value to the first element
           ...
           *pPointer = 20; // assign a value to the second element
           ...
           //assign the address of the third element to the 
           pPointer = &numbersArray[2];
           *pPointer = 30; // assign a value to the third element

           //assign the address of the fourth element to the  pointer using pointer arithmentic
           ...
           *(pPointer + 4) =50;
           ...
           //iterate and output all the elemnts in the array
           for( int n =0; n<5; n++){
            cout<<numbersArray[n] << ",";
           }
           return 0 ;
